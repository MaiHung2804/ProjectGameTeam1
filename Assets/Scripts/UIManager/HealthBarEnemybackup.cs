...
public class HealthBarEnemybackup : MonoBehaviour
{
    [SerializeField] private UnityEngine.UI.Image emptyBar;
    [SerializeField] private TextMeshProUGUI levelText;
    [SerializeField] private TextMeshProUGUI aboveText;

    private static HealthBarEnemybackup instance;
    public static HealthBarEnemybackup Instance => instance;
    ...
    private void OnEnable()
    {
        ...
        UnitBase unitBase = PlayerManager.Instance.PlayerBase;
    ...
    ////    if (UIHealthBarManager.Instance == null) return;

    ////    hpBarRec.anchoredPosition = WordToCanvas(unitPos, UIHealthBarManager.Instance.CanvasRect)
    ...
    ////        UIHealthBarManager.Instance.Canvas.renderMode == RenderMode.ScreenSpaceOverlay ? null : Camera.main, out localCanvasPos);
